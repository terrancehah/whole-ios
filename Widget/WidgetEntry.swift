...
struct QuoteWidgetProvider: TimelineProvider {
    ...
    private func fetchQuoteSync(category: QuoteCategory) -> Quote {
        ...
        return Quote(id: UUID(), englishText: "Stay hungry, stay foolish.", chineseText: "求知若饥，虚心若愚。", category: .inspiration, createdAt: nil, createdBy: nil)
    }

    func placeholder(in context: Context) -> QuoteWidgetEntry {
        QuoteWidgetEntry(date: Date(), quote: Quote(id: UUID(), englishText: "Stay hungry, stay foolish.", chineseText: "求知若饥，虚心若愚。", category: .inspiration, createdAt: nil, createdBy: nil), theme: .sereneMinimalism)
    }

    func getSnapshot(in context: Context, completion: @escaping (QuoteWidgetEntry) -> ()) {
        let quote = loadWidgetDailyQuote() ?? Quote(id: UUID(), englishText: "Stay hungry, stay foolish.", chineseText: "求知若饥，虚心若愚。", category: .inspiration, createdAt: nil, createdBy: nil)
